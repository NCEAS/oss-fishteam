...
##Import Data
```{r import data and load packages, echo=TRUE, include=TRUE}
...
barplot(rev(sort(table(rs_gear$GEAR_COMBO))))
```
...
```{r}
location_gearST_redsnapper_summer<- location_gearST_redsnapper %>% dplyr::filter(month==6:11)
