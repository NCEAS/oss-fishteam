...
```{r correlation, results="hide", warning=FALSE, message=FALSE}
library(mgcv)
...
![output correlation](Correlation_data_output.pdf)
...
```{r}
#insert code to create GAMM output figures here, and picture of significance table
```
...
(include map as image of observed versus predicted)
